...
class _SignupScreenState extends State<SignupScreen> {
  ...
  final TextEditingController emergencyPhNumberController =
  ...
  void handleSignUp() async {
    ...
    String emergencyPhone = emergencyPhNumberController.text.trim();
    String emergencyContact = emergencyNameController.text.trim();
    String desc = descriptionController.text.trim();
    String origin = originalPlaceController.text.trim();
        ...
        children: [
          Expanded(
            child: TextFormField(
              ...
              readOnly:
                  true, // Make the field read-only, as the user will pick the date
            ),
          ),
          IconButton(
            icon: const Icon(
              Icons.calendar_today,
              color: Color.fromARGB(255, 119, 15, 123),
            ),
            onPressed: () {
              _selectDate(context);
            },
