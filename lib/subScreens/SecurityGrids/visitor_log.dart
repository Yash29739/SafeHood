...
class _VisitorLogsPageState extends State<VisitorLogsPage> {
  final List<Map<String, String>> visitorLogs = [
    ...
    {"name": "Robert Brown", "purpose": "Interview", "time": "2025-03-21 12:15"},
  ];
          ...
          children: [
            Expanded(
              child: visitorLogs.isEmpty
                  ? Center(child: Text("No visitor logs available.", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)))
                  : ListView.builder(
